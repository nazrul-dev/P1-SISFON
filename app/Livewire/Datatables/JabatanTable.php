...
class JabatanTable extends DataTableComponent
{



    public string $tableName = 'jabatans';
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make("Tipe Jabatan", "tipe_jabatan")->searchable()
                ->sortable()->collapseOnTablet(),
