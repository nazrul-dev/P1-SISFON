...
new class extends Component {
    ...
    public $data = [];
    public $form = false;
    public $kua_select = true;
    public $ids, $name, $role_user, $email, $password, $nip, $telepon, $jabatan_id, $kua_id;
    ...
    public function mount()
    {
        ...
        if ($user->tipe_user === 'kua'  && $user->role_user !== 'superadmin') {
            $this->kua_id = $user->kua_id;
            $this->kua_select = false;
        }
    }
    ...
    public function store()
    {
        ...
        $this->data = User::create([...$validated, 'password' => Hash::make($this->password), 'tipe_user' => 'kua', 'jabatan_id' => $this->jabatan_id, 'nip' => $this->nip, 'telepon' => $this->telepon]);
        $this->handleFormReset();
    ...
    {
        $this->reset('ids', 'name', 'email', 'password', 'nip', 'telepon', 'jabatan_id', 'kua_id');
    }
...
<div>
    ...
    <x-card>
        ...
        <div>
            ...
            <livewire:datatables.user-table tipe="kua" />
    ...
    @if ($form)
        ...
        <div class="fixed   inset-0 end-0 w-96 bg-white z-10  ml-auto">
            ...
            <div class="p-5 pb-32 space-y-2 overflow-y-auto h-screen soft-scrollbar">
                <x-select label="KUA " :disabled="!$kua_select" wire:model="kua_id" placeholder="KUA " :async-data="route('select-datakua')"
                    option-label="nama_kecamatan" option-value="id">
                </x-select>
