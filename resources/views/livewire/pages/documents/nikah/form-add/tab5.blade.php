...
new class extends Component {
            ...
            if (isset($this->props['II'])) {
                if (isset($this->props['II']['status_perkawinan'])) {
                    if ($this->props['II']['status_perkawinan'] === 'Duda (Cerai Mati)') {
                        ...
                        $this->n6 = false;
                        if (isset($this->props['III']) && $this->props['III']['i_status_perkawinan'] === 'Janda (Cerai Mati)') {
                            $this->i_n6 = true;
                        } else {
                            $this->i_n6 = false;
                        }
    ...
    public function save()
    {
        ...
        if ($this->n6) {
            ...
            $this->dispatch('next-tab', data: $request, tab: 'V', nextTab: 'VII');
        } else {
            $this->dialog()->confirm([
    ...
    {
        $this->dispatch('finish', data: $data, tab: 'V');
    }
}; ?>
    ...
    <div id="top4">
        <div class="grid grid-cols-2 gap-2">
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="col-span-2">
                    <x-textarea :disabled="$i_piatu" label="Alamat" wire:model="ii_alamat" />
                </div>
            </div>
