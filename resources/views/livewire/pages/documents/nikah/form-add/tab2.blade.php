...
use App\Models\{DataN6,Village};
new class extends Component {
    public $props;
    public $n6_id;
    public $nama, $alamat, $gelar_depan, $gelar_belakang, $pendidikan_terakhir, $nama_panggilan, $tempat_lahir, $tanggal_lahir, $nik, $status_warganegara, $agama, $pekerjaan_id, $nomor_handphone, $village_id, $status_perkawinan, $istri_ke = 0, $nama_istri_terdahulu;
    ...
    {
        if($this->status_perkawinan === 'Jejaka'){
            $this->istri_ke = 0;
        }else{
            $this->istri_ke = 1;
        }
    ...
    public function save()
    {
        ...
        $vilID = Village::where('code', $this->village_id)->first();
...
<x-card title="II. Suami">
    ...
    <div id="top1" >
        ...
        <div class="grid grid-cols-2 gap-2">
            ...
            <x-select label="Status Perkawinan" placeholder="Pilih salah satu" :options="['Jejaka', 'Duda (Cerai Mati) Terdaftar', 'Duda (Cerai Mati)', 'Duda (Cerai Hidup)', 'Beristri']"
                ...
                <x-input :disabled="$status_perkawinan === 'Jejaka'" type="number" label="Istri Ke"  wire:model.live="istri_ke"/>
    ...
    <x-slot name="footer">
        <div class="flex justify-between items-center">
            ...
            <x-button  x-data label="Lanjutkan" wire:click="save()" id="scrolltop" primary />
        </div>
    </x-slot>
</x-card>
