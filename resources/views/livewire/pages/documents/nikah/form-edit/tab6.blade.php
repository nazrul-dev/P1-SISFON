...
new class extends Component {
    ...
    public $props;
    public $wajib = false;
    public $n6_nomor_surat_keluar, $n6_tanggal_meninggal, $n6_alamat_tempat_meninggal, $n6_nama, $n6_gelar_depan, $n6_gelar_belakang, $n6_pendidikan_terakhir, $n6_nama_panggilan, $n6_binti, $n6_tipe_bin, $n6_tempat_lahir, $n6_tanggal_lahir, $n6_nik, $n6_status_warganegara, $n6_agama, $n6_pekerjaan_id, $n6_village_id;
    ...
    public function save()
    {
        ...
        $request = [...$validated, 'n6_tipe_bin' => $this->n6_tipe_bin, 'n6_gelar_depan' => $this->n6_gelar_depan, 'n6_gelar_belakang' => $this->n6_gelar_belakang];
        $this->dialog()->confirm([
