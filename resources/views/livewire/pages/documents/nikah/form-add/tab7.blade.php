...
new class extends Component {
    ...
    {
        if (isset($this->props['VII'])) {
            foreach ($this->props['VII'] as $key => $value) {
                $this->$key = $value;
            }
        }

        if (isset($this->props['III'])) {
            if (isset($this->props['III']['i_status_perkawinan']) && $this->props['III']['i_status_perkawinan'] == 'Janda (Cerai Mati)') {
                $this->wajib = true;
            }
        }
    }
    ...
    {
        $this->dispatch('back-tab', data: $this->props, tab: 'VI');
    }
    ...
    {
        $this->dispatch('finish', data: $data, tab: 'VII');
    }
}; ?>
...
<x-card title="VI. N6">
    ...
    <div>
        <div class="grid grid-cols-2 gap-2">
            ...
            <x-input label="Nama Mantan Suami" wire:model="n6_nama" placeholder="Nama Mantan Suami" />
